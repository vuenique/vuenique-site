  ...
  <section class="pt-20">
    ...
    >
      <div class="lg:pr-20 flex-col items-center pt-8 lg:pt-0">
        <h1
          class="text-center lg:text-left text-5xl lg:text-8xl bg-gradient-to-r from-greenP to-blue-300 text-transparent bg-clip-text"
        >
      ...
      <div class="round-md order-first lg:order-last lg:px-0">
        <img
          src="../../assets/Vuenique1.svg"
          class="w-20 h-20 md:w-[32rem] md:h-[32rem]"
        />
      </div>
    </div>
  </section>
