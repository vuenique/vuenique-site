...
import FeatureItem1 from './FeatureItems/FeatureItem1.vue';
import FeatureItem2 from './FeatureItems/FeatureItem2.vue';
import FeatureItem3 from './FeatureItems/FeatureItem3.vue';
</script>
