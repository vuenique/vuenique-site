...
<template>
  <div
    class="bg-charcoalP h-fit px-4 py-4 rounded-xl shadow-blue-400 shadow-md hover:shadow-lg hover:shadow-blue-300 hover:scale-y-105 hover:scale-x-105 transition duration-500"
    ref="cardForWidth"
  >
    ...
    <!-- -->
    <!-- -->
    <h1 v-if="props.render" class="cardWidth text-center text-xl text-whiteB py-2">
      {{ props.title }}
    </h1>
